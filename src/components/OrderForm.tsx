      ...
      <div className="bg-white dark:bg-gray-850 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 rounded-lg p-4">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700 mb-3">
          ...
          {/* Fournisseur */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700 mb-1">Nom du fournisseur</label>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700">Articles</label>
            ...
            {items.length > 0 && (
              <div className="mt-4 bg-green-50 dark:bg-green-950 border border-green-200 rounded-lg p-4">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700 mb-2">Appliquer une réduction</label>
          ...
          {/* ── Lien de la commande ───────────────────────────── */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700 mb-1">Lien de la commande</label>
            <div className="flex gap-2">
              <input
                type="text"
                value={orderLink}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700 mb-1">Lien de suivi</label>
            <div className="flex gap-2">
              <input
                type="text"
                value={trackingLink}
            ...
            {!dateExtracting && dateExtractStatus === 'success' && (
              <div className="mt-2 flex items-center gap-2 text-sm text-green-700 bg-green-50 dark:bg-green-950 border border-green-200 rounded-lg px-3 py-2">
                <CheckCircle size={14} className="shrink-0" />
                {dateExtractMsg}
              </div>
            )}
            {!dateExtracting && dateExtractStatus === 'error' && (
              <div className="mt-2 flex items-center gap-2 text-sm text-amber-700 bg-amber-50 dark:bg-amber-950 border border-amber-200 rounded-lg px-3 py-2">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
            <div className="flex justify-between items-center">
              <span className="text-lg font-medium text-gray-700 dark:text-gray-300 dark:text-gray-700">Prix total:</span>
              <span className="text-2xl font-bold text-blue-600">{getTotalPrice().toFixed(2)} €</span>
            </div>
          </div>

          {error && <div className="p-3 bg-red-50 dark:bg-red-950 text-red-700 rounded-lg text-sm">{error}</div>}
          ...
          <div className="flex gap-3">
            ...
            <button type="button" onClick={onClose}
              className="flex-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 dark:text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-300">
              Annuler
            </button>
          </div>
        </form>
