    ...
    <div className="mb-6 bg-white dark:bg-gray-850 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none overflow-hidden">
      ...
      <div className="divide-y divide-gray-100 dark:divide-gray-700">
        {deliveries.map(({ order, date, diffDays, noTracking }) => {
          ...
          return (
            <div key={order.id} onClick={() => order.tracking_link && window.open(order.tracking_link, '_blank')} className={`px-5 py-3 transition-colors cursor-pointer ${isDone ? 'bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:bg-gray-700' : 'hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900'}`}>
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  {status === 'available' && (
                    <div className="flex items-center gap-1.5">
                      <span className="flex items-center gap-1 text-xs px-2 py-1 rounded-lg border border-blue-300 text-blue-700 bg-blue-50 dark:bg-blue-950 font-medium">
